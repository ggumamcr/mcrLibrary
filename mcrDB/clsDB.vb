...
#Region "Connexion"
    ...
    Public Shared Sub dbGetConnectionParameters(ByRef dbSource As String, ByRef dbDatabase As String,
                                         ByRef dbIntegratedSecurity As Boolean,
                                         ByRef dbUser As String, ByRef dbPassword As String,
    ...
    Public Overloads Shared Sub dbSetConnectionParameters(ByVal dbSource As String, ByVal dbDatabase As String,
                                        ByVal dbIntegratedSecurity As Boolean,
                                        ByVal dbUser As String, ByVal dbPassword As String,
